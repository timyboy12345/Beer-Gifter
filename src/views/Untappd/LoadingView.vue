<template>
  <div>
    ...
    <div class="flex flex-row justify-center my-8">
      <svg aria-hidden="true" class="w-8 h-8 mr-2 text-gray-200 animate-spin dark:text-gray-100 fill-yellow-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="mt-8 mb-4 text-gray-600">{{ userStore.checkins.length }} checkins opgehaald.</div>
  </div>
</template>
